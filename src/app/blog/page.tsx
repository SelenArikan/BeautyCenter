...
export default function BlogPage() {
    ...
    return (
        <div className="min-h-screen bg-[#ffffff] text-[#000000] font-logo">

            {/* Top Navigation */}
            <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-[#ec4cc7]/10">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-10">
                        <Link href="/" className="text-sm font-semibold hover:text-[#ec4cc7] transition-colors uppercase tracking-wider">
                            Ana Sayfa
                        </Link>
                        <Link href="/#services" className="text-sm font-semibold hover:text-[#ec4cc7] transition-colors uppercase tracking-wider">
                            Hizmetler
                        </Link>
                        <span className="text-sm font-semibold text-[#ec4cc7] uppercase tracking-wider cursor-default">
                            Blog
                        </span>
                        <a href="https://wa.me/905385296388" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold hover:text-[#ec4cc7] transition-colors uppercase tracking-wider">
                            İletişim
                        </a>
                    </nav>
                    <a
                        ...
                        className="bg-[#ec4cc7] text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-[#8E4D5B] transition-all shadow-lg shadow-[#ec4cc7]/20"
                    >
                        RANDEVU AL
                    </a>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
                ...
                >
                    <h2 className="text-5xl md:text-6xl font-bold text-[#000000] mb-4">Güzellik Blogu</h2>
                ...
                {featuredPost && activeCategory === "Tümü" && (
                    <motion.section
                        ...
                        className="mb-20"
                    >
                        <div className="relative group overflow-hidden rounded-2xl bg-white shadow-xl flex flex-col lg:flex-row items-center border border-[#ec4cc7]/5">
                            ...
                            <div className="w-full lg:w-2/5 p-8 lg:p-14 flex flex-col justify-center gap-6">
                                <span className="text-[#ec4cc7] font-bold tracking-[0.2em] text-xs uppercase">Öne Çıkan Yazı</span>
                                ...
                                <div>
                                    <Link
                                        ...
                                        className="inline-block bg-[#ec4cc7] text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-widest hover:shadow-xl hover:-translate-y-1 transition-all"
                                    >
                                        Devamını Oku
                                    </Link>
                                </div>
                ...
                <motion.div
                    ...
                    className="mb-12 border-b border-[#ec4cc7]/10 flex flex-wrap gap-6 md:gap-12 pb-4 overflow-x-auto"
                >
                    {categories.map(cat => (
                        <button
                            key={cat}
                            ...
                            className={`text-sm font-bold uppercase tracking-widest pb-4 transition-colors whitespace-nowrap ${activeCategory === cat
                                ? 'border-b-2 border-[#ec4cc7] text-[#ec4cc7]'
                                : 'text-[#5D6D7E]/60 hover:text-[#ec4cc7]'
                                }`}
                        >
                            {cat}
                        </button>
                ...
                <section className="mb-24">
                    <h4 className="text-2xl font-bold mb-8 flex items-center gap-3">
                        Son Yazılar
                        <span className="h-px bg-[#ec4cc7]/20 grow"></span>
                    </h4>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <div className="flex items-center justify-between">
                                            <span className="text-[#ec4cc7] text-[10px] font-bold uppercase tracking-widest">{post.category}</span>
                                            <span className="text-[#5D6D7E]/50 text-xs">{post.date}</span>
                                        </div>
                                        <h5 className="text-2xl font-bold leading-snug group-hover:text-[#ec4cc7] transition-colors">
                                            {post.title}
                                        </h5>
                                        <p className="text-[#5D6D7E] line-clamp-2">{post.excerpt}</p>
                                        <Link
                                            href={`/blog/${post.id}`}
                                            className="inline-flex items-center gap-2 text-[#ec4cc7] text-xs font-bold uppercase tracking-widest mt-2 hover:gap-3 transition-all"
                                        >
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="bg-[#ec4cc7]/5 rounded-2xl p-8 md:p-16 flex flex-col items-center text-center gap-8 border border-[#ec4cc7]/10 mb-12"
                >
                    <div className="max-w-xl">
                        <Mail size={40} className="text-[#ec4cc7] mx-auto mb-4" />
                    ...
                    <form className="w-full max-w-md flex flex-col md:flex-row gap-4" onSubmit={(e) => e.preventDefault()}>
                        <input
                            className="flex-grow bg-white border-none rounded-full px-6 py-4 focus:ring-2 focus:ring-[#ec4cc7] transition-all text-sm outline-none"
                        ...
                        />
                        <button
                            className="bg-[#ec4cc7] text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-[#8E4D5B] transition-all whitespace-nowrap"
                            type="submit"
                        >
                            ABONE OL
                        </button>
            ...
            {/* Footer */}
            <footer className="bg-white border-t border-[#ec4cc7]/10 py-12">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
                    <Link href="/" className="flex items-center gap-3">
                        <img src="/assets/logo/logo.png" alt="Love Yourself By Anastasiya" className="h-8 md:h-10 w-auto transition-transform duration-300 hover:scale-105" />
                    </Link>
                    <div className="flex gap-4">
                        <a href="https://www.instagram.com/loveyourselfbyanastasiya/" target="_blank" rel="noopener noreferrer" className="text-[#5D6D7E]/40 hover:text-[#ec4cc7] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
                        </a>
                        <a href="https://wa.me/905385296388" target="_blank" rel="noopener noreferrer" className="text-[#5D6D7E]/40 hover:text-[#ec4cc7] transition-colors">
