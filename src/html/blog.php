...
<div class="min-h-screen bg-[#ffffff] text-[#000000] font-georgia mt-24">
    <main class="container mx-auto px-4 md:px-8 max-w-7xl py-12">
        ...
        <!-- Newsletter -->
        <section
            class="bg-[#ec4cc7]/5 rounded-2xl p-8 md:p-16 flex flex-col items-center text-center gap-8 border border-[#ec4cc7]/10 mb-12">
            <div class="max-w-xl">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    stroke="#ec4cc7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="mx-auto mb-4">
            ...
            <form class="w-full max-w-md flex flex-col md:flex-row gap-4" onsubmit="event.preventDefault();">
                <input
                    class="flex-grow bg-white border-none rounded-full px-6 py-4 focus:ring-2 focus:ring-[#ec4cc7] transition-all text-sm outline-none"
                    placeholder="E-posta adresiniz" type="email" required />
                <button
                    class="bg-[#ec4cc7] text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-[#8E4D5B] transition-all whitespace-nowrap"
                    type="submit">
                    ABONE OL
                </button>
            </form>
