...
<!-- Hero Section -->
<div class="relative h-screen w-full overflow-hidden bg-[#f9def1]">
    ...
    <div
        class="container relative z-10 mx-auto px-4 md:px-8 max-w-7xl h-full flex flex-col justify-center items-center text-center text-[#000000] pt-20">
        <div class="fade-in-up">
            <h2 class="text-lg md:text-xl font-bold tracking-[0.4em] uppercase mb-4 text-[#ec4cc7]">
                Güzelliğin Yeni Adresi
            </h2>
        </div>
        <div class="fade-in-up" style="transition-delay: 0.2s">
            <h1 class="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 leading-tight text-[#000000]">
                Kendini <br class="hidden md:block" />
                <span class="italic font-serif font-light text-[#ec4cc7]">Yeniden</span> Keşfet
            </h1>
        </div>
        <div class="fade-in-up" style="transition-delay: 0.4s">
            <p class="max-w-xl mx-auto text-lg md:text-xl text-[#000000]/90 font-light leading-relaxed mb-12">
        ...
        <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 fade-in-up"
            ...
            <span class="text-[10px] uppercase tracking-[0.2em] text-[#000000]/60">Aşağı Kaydır</span>
            <div class="animate-bounce mt-2">
                <i data-lucide="chevron-down" class="text-[#000000]/80"></i>
            </div>
        </div>
    </div>
</div>
...
<section class="py-20 md:py-32 bg-white" id="services" x-data="{ activeService: null }">
    <div class="container mx-auto px-4 md:px-8 max-w-7xl">
        <div class="text-center mb-16 fade-in-up">
            <h3 class="text-[#ec4cc7] font-bold text-sm tracking-[0.2em] uppercase mb-4">Özel Bakım</h3>
            <h2 class="text-4xl md:text-5xl font-bold text-[#000000] mb-6">Hizmetlerimiz</h2>
            <div class="w-24 h-1 bg-[#ec4cc7] mx-auto rounded-full"></div>
        </div>

        <div class="space-y-24">
            <?php foreach ($serviceCategories as $catIndex => $category): ?>
                <div class="fade-in-up">
                    <h2 class="text-4xl md:text-5xl font-bold text-[#000000] mb-4 tracking-tight uppercase font-serif">
                    ...
                    <div class="flex flex-col gap-3 mb-10">
                        <?php foreach ($category['services'] as $sIndex => $service):
                            ...
                            <button
                                ...
                                :class="activeService === '<?= $serviceKey ?>' ? 'bg-[#000000] text-white shadow-lg' : 'bg-[#ec4cc7]/15 text-[#000000] hover:bg-[#ec4cc7] hover:text-white'"
                    ...
                    <div class="relative overflow-hidden min-h-[400px]">
                        ...
                        <?php foreach ($category['services'] as $sIndex => $service):
                            ...
                            <div x-show="activeService === '<?= $serviceKey ?>'" x-collapse.duration.500ms
                                style="display: none;">
                                <div class="bg-[#ffffff] rounded-2xl overflow-hidden shadow-xl mt-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2">
                                        <div class="p-8 md:p-12 flex flex-col justify-center">
                                            <h3 class="text-2xl md:text-3xl font-bold text-[#000000] mb-4">
                                                <?= htmlspecialchars($service['name']) ?>
                                            </h3>
                                            <p class="text-[#5D6D7E] text-base leading-relaxed mb-6 font-light">
                                                <?= htmlspecialchars($service['details']) ?>
                                            </p>
                                            <div class="flex items-center gap-2 text-[#ec4cc7] font-semibold text-sm mb-6">
                                                <i data-lucide="clock" class="w-4 h-4"></i>
                                                <?= htmlspecialchars($service['duration']) ?>
                                            </div>
                                            <a href="hizmet.php?slug=<?= htmlspecialchars($service['slug']) ?>"
                                                class="w-fit px-6 py-3 bg-[#ec4cc7] hover:bg-[#8E4D5B] text-white text-sm font-bold uppercase tracking-widest rounded-full transition-all duration-300 transform hover:-translate-y-0.5 shadow-md inline-block">
                                                Şimdi Keşfet
                                            </a>
                                        </div>
        ...
        <div class="mt-16 text-center text-[#000000] fade-in-up">
            <button @click="isShowroomOpen = true"
                class="inline-flex items-center gap-2 px-8 py-4 bg-transparent border border-[#ec4cc7] text-[#ec4cc7] hover:bg-[#ec4cc7] hover:text-white text-sm font-bold uppercase tracking-widest rounded-full transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-lg">
                Tüm Hizmetlerimiz
...
<!-- Intro Section -->
<section class="py-20 md:py-32 bg-[#ffffff]">
    <div class="container mx-auto px-4 md:px-8 max-w-7xl">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="fade-in-right relative group overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/70 to-transparent">
                    <div class="flex items-center gap-2 text-[#ec4cc7]">
            ...
            <div class="fade-in-left">
                <h3 class="text-[#ec4cc7] font-bold text-sm tracking-[0.2em] uppercase mb-4">
                    Love Yourself Güzellik
                </h3>
                <h2 class="text-4xl md:text-5xl font-bold text-[#000000] mb-8 leading-tight">
                    Estetik ve Bakımın <br />
                    <span class="font-serif italic font-normal text-[#ec4cc7]">Buluştuğu Nokta</span>
                </h2>
                ...
                <button @click="isShowroomOpen = true"
                    class="inline-flex items-center gap-2 text-[#000000] font-semibold uppercase tracking-widest border-b-2 border-[#ec4cc7] pb-1 hover:text-[#ec4cc7] transition-colors cursor-pointer">
...
<!-- Featured Experience -->
<section class="py-20 md:py-32 relative bg-[#f9def1] overflow-hidden">
    <div
    ...
    <div class="container relative z-10 mx-auto px-4 md:px-8 max-w-7xl">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 fade-in-right">
                <h3 class="text-[#ec4cc7] font-bold text-sm tracking-[0.2em] uppercase">Size Özel</h3>
                <h2 class="text-4xl md:text-6xl font-bold text-[#000000] leading-tight">
                    Ruhunuzu ve Bedeninizi <br />
                    <span class="font-serif italic font-light text-[#ec4cc7]">Dinlendirin</span>
                </h2>
                <p class="text-[#000000]/80 text-lg font-light leading-relaxed">
                ...
                <div class="grid grid-cols-2 gap-8 pt-4">
                    <div class="flex flex-col gap-2">
                        <div
                            class="w-12 h-12 bg-[#ec4cc7] rounded-full flex items-center justify-center text-white mb-2">
                            <i data-lucide="coffee" class="w-6 h-6"></i>
                        </div>
                        <h4 class="text-[#000000] font-bold text-lg">Detoks Bar</h4>
                        <p class="text-[#000000]/60 text-sm font-light">Sağlıklı içecekler ve atıştırmalıklar.</p>
                    </div>
                    <div class="flex flex-col gap-2">
                        <div
                            class="w-12 h-12 bg-[#ec4cc7] rounded-full flex items-center justify-center text-white mb-2">
                        ...
                        <h4 class="text-[#000000] font-bold text-lg">VIP Odalar</h4>
                        <p class="text-[#000000]/60 text-sm font-light">Size özel hazırlanmış bakım alanları.</p>
                    </div>
                </div>
            </div>
...
<!-- Blog Section -->
<section class="py-20 md:py-32 bg-[#ffffff]" id="blog">
    <div class="container mx-auto px-4 md:px-8 max-w-7xl">
        <div class="text-center mb-16 fade-in-up">
            <h3 class="text-[#ec4cc7] font-bold text-sm tracking-[0.2em] uppercase mb-4">Blog</h3>
            <h2 class="text-4xl md:text-5xl font-bold text-[#000000] mb-6">Güzellik Rehberi</h2>
            <div class="w-24 h-1 bg-[#ec4cc7] mx-auto rounded-full mb-6"></div>
                    ...
                    <div
                        ...
                        <div class="relative h-56 overflow-hidden">
                            ...
                            <div class="absolute top-4 left-4">
                                <span
                                    class="px-3 py-1 bg-[#ec4cc7] text-white text-xs font-bold uppercase tracking-wider rounded-full">
                                    <?= htmlspecialchars($post['category']) ?>
                                </span>
                            </div>
                        </div>
                        <div class="p-6">
                            <span class="text-[#ec4cc7] text-xs font-medium tracking-wide">
                                <?= htmlspecialchars($post['date']) ?>
                            </span>
                            <h3
                                class="text-xl font-bold text-[#000000] mt-2 mb-3 group-hover:text-[#ec4cc7] transition-colors leading-snug">
                            ...
                            <span
                                class="inline-flex items-center gap-2 text-[#ec4cc7] text-sm font-semibold uppercase tracking-wide group-hover:gap-3 transition-all">
    ...
    <div class="container mx-auto px-4 md:px-8 max-w-7xl">
        <div class="text-center mb-16 fade-in-up">
            <div class="flex items-center justify-center gap-3 mb-4">
                ...
                <h3 class="text-[#ec4cc7] font-bold text-sm tracking-[0.2em] uppercase">Google Yorumları</h3>
            </div>
            <h2 class="text-4xl md:text-5xl font-bold text-[#000000] mb-6">Misafirlerimiz Ne Diyor?</h2>
            <div class="w-24 h-1 bg-[#ec4cc7] mx-auto rounded-full mb-8"></div>

            <!-- Rating Summary -->
            <div class="flex flex-col items-center gap-3 fade-in-up">
                <div class="flex items-center gap-4">
                    <span class="text-5xl font-bold text-[#000000]">5.0</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 fade-in-up">
            ...
            $colors = ['#ec4cc7', '#4285F4', '#34A853', '#EA4335', '#FBBC05'];
            foreach ($reviews as $i => $review):
                ?>
                <div class="bg-[#ffffff] rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-[#000000] text-sm">
        ...
        <div class="text-center mt-12 fade-in-up">
            <a href="https://www.google.com/maps/search/Love+Yourself+by+Anastasiya+B%C3%BCy%C3%BCk%C3%A7ekmece"
                ...
                class="inline-flex items-center gap-2 px-8 py-3 bg-[#ec4cc7] hover:bg-[#8E4D5B] text-white text-sm font-bold uppercase tracking-widest rounded-full transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg">
                Yorum Bırakın
                <i data-lucide="arrow-right" class="w-4 h-4"></i>
            </a>
        </div>
